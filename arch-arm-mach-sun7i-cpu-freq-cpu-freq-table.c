...
struct cpufreq_frequency_table sunxi_freq_tbl[] = {
    ...
    { .frequency = 864000,  .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 912000,  .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 960000,  .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 1008000, .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 1056000, .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 1104000, .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 1152000, .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 1200000, .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 1248000, .index = SUNXI_CLK_DIV(1, 2, 2, 2), },
