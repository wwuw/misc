...
#undef CPUFREQ_ERR
#if (0)
    #define CPUFREQ_DBG(format,args...)   printk("[cpu_freq mach-sun7i] DBG:"format,##args)
#else
...
#define SUNXI_CPUFREQ_MIN       (912000000)      /* config the minimum frequency of sunxi core */
